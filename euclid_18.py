...
#for i in dataset : #k,r
#    for ii in dataset[i] : #dataset [k] s for size = 100 ,ii[0] ois 1 and ii[1] is 2
...
full_data =  df.astype(float).values.tolist() # to convert every thing to int/float
